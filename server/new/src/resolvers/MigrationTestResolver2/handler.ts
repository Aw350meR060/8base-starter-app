 ...
 *    8base invoke-local MigrationTestResolver2 -p src/resolvers/MigrationTestResolver2/mocks/request.json
 *
 *  (2) Default mock file location using -m flag:
 *    8base invoke-local MigrationTestResolver2 -m request
 *
 ...
 *    8base generate mock MigrationTestResolver2 -m [MOCK_FILE_NAME]
 */
